...
const Approach=()=> {
    ...
    <div className="my-20 flex flex-col lg:flex-row items-center justify-center gap-4">
        <Card
            ...
            description="Data Acquisition, Data Cleaning and Preparation, EDA and Feature Engineering:Data Analysis.">
        <CanvasRevealEffect
            animationSpeed={5.1}
        ...
        description="Leveraging SQL and visualization to uncover patterns and trends within the data & Modeling and Machine Learning:Data Alchemy">
        <CanvasRevealEffect
            animationSpeed={3}
        ...
        description="Develope comprehensive reports and dashboards, cultivate business acumen, and foster strong professional networks:Data Visualization & Data Storytelling">
        <CanvasRevealEffect
            animationSpeed={3}
